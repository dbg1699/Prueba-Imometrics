...
# Primer punto
SELECT Name FROM country WHERE SurfaceArea > 9000000;
SELECT * FROM country INNER JOIN countrylanguage ON country.Code=countrylanguage.CountryCode;

# Segundo punto
SELECT countrylanguage.Language FROM country INNER JOIN countrylanguage 
ON country.Code=countrylanguage.CountryCode and country.Name ='United States';

# Tercer punto
SELECT city.Name, city.Population, country.Name FROM country INNER JOIN city 
ON country.Code=city.CountryCode ORDER BY city.population DESC LIMIT 10;

# Cuarto punto
SELECT city.Name, country.Name, country.Continent FROM country INNER JOIN city 
ON country.Code=city.CountryCode and country.Capital = city.ID where country.Continent LIKE '%America%';
